...
- 或[下载这个文件](https://github.com/xinnan-tech/xiaozhi-esp32-server/blob/main/main/xiaozhi-microserver/mcp_server_settings.json)，下载到`data`目录下，并重命名为`.mcp_server_settings.json`
