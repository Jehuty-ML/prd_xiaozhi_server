export default {
  ...
  'serverSideManager.updateConfig': 'Notify Update Config',
  'serverSideManager.restartServer': 'Restart Server',
  'serverSideManager.updateConfigTitle': 'Notify Update Config (Broadcast)',
  'serverSideManager.confirmRestart': 'Are you sure you want to restart the server?',
  'serverSideManager.confirmUpdateConfig': 'Notify this WS instance to reload config? This reloads global params and broadcasts session_state.mode to all online devices on this instance (force interrupt to IDLE).',
  'serverSideManager.broadcastHint': 'Broadcast Speak auto-enters play_only (no chat) on online devices, then restores common after playback ends or abort. Keep session_state.mode=common in Params; no manual switch needed.',
  'serverSideManager.broadcastSpeakTitle': 'Broadcast Speak',
  'serverSideManager.broadcastSpeak': 'Broadcast Speak',
  'serverSideManager.broadcastSpeakPlaceholder': 'Text to speak on all online devices (max 500 chars)',
  'serverSideManager.broadcastSpeakEmpty': 'Please enter speak text',
  'serverSideManager.confirmBroadcastSpeak': 'Broadcast this text to all online devices on this WS instance? Current playback will be interrupted.',
  'serverSideManager.broadcastSpeakSuccess': 'Speak text dispatched',
  ...
  'serverSideManager.updateConfigSuccess': 'Config updated and session mode broadcast to online devices',
