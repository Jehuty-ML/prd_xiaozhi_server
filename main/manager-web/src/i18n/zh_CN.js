export default {
  ...
  'serverSideManager.updateConfig': '通知更新配置',
  'serverSideManager.restartServer': '重启服务端',
  'serverSideManager.updateConfigTitle': '通知更新配置（广播）',
  'serverSideManager.confirmRestart': '确定要重启服务端吗？',
  'serverSideManager.confirmUpdateConfig': '确定向该 WS 实例通知更新配置吗？将重载全局参数，并把 session_state.mode 广播到本实例全部在线设备（强制打断回 IDLE）。',
  'serverSideManager.broadcastHint': '广播播报会自动让在线设备进入 play_only（禁对话），播完或打断后自动回到 common。参数管理里的 session_state.mode 可保持 common，无需手改。',
  'serverSideManager.broadcastSpeakTitle': '广播播报',
  'serverSideManager.broadcastSpeak': '广播播报',
  'serverSideManager.broadcastSpeakPlaceholder': '输入要向全部在线设备播报的文案（最多500字）',
  'serverSideManager.broadcastSpeakEmpty': '请先输入播报文案',
  'serverSideManager.confirmBroadcastSpeak': '确定向该 WS 实例全部在线设备广播这段播报文案吗？将打断当前播放。',
  'serverSideManager.broadcastSpeakSuccess': '播报文案已下发',
  ...
  'serverSideManager.updateConfigSuccess': '配置已更新，并已向在线设备广播会话模式',
