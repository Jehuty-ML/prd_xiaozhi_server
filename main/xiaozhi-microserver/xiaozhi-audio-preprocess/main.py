...
from xiaozhi_common.constants import PREPROCESS_SERVICE  # noqa: E402
from xiaozhi_common.logging import setup_logging  # noqa: E402


def build_config():
    parser = argparse.ArgumentParser(description="xiaozhi-audio-preprocess")
    add_common_arguments(
        parser,
        service_name=PREPROCESS_SERVICE,
        server_name="xiaozhi_audio_preprocess",
        default_grpc_port=50054,
    )
