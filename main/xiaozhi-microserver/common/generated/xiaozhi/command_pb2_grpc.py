...
class AccessCommandServiceStub(object):
...
class AccessCommandServiceServicer(object):
    """Access command surface (listen state, device cmds, capacity)
    """
...
class AccessCommandService(object):
    """Access command surface (listen state, device cmds, capacity)
    """
...
class AccessDeviceProxyServiceStub(object):
...
class AccessDeviceProxyServiceServicer(object):
    """Agent → Access: proxy MCP/IoT frames onto the device WebSocket
    """
...
def add_AccessDeviceProxyServiceServicer_to_server(servicer, server):
 ...
 # This class is part of an EXPERIMENTAL API.
class AccessDeviceProxyService(object):
    """Agent → Access: proxy MCP/IoT frames onto the device WebSocket
    """
