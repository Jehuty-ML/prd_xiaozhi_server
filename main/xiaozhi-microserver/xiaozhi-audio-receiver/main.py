...
from xiaozhi_common.constants import RECEIVER_SERVICE  # noqa: E402
from xiaozhi_common.logging import setup_logging  # noqa: E402


def build_config():
    parser = argparse.ArgumentParser(description="xiaozhi-audio-receiver")
    add_common_arguments(
        parser,
        service_name=RECEIVER_SERVICE,
        server_name="xiaozhi_audio_receiver",
