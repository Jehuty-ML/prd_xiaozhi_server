...
from xiaozhi_common.constants import DEFAULT_PORTS, MODEL_ADMIN_HTTP_PORT, MODEL_ADMIN_SERVICE
...
def serve(config: BaseServerConfig) -> None:
    ...
    def run_http() -> None:
        ...
        uv = uvicorn.Config(app, host="0.0.0.0", port=http_port, loop="asyncio", log_level="info")
